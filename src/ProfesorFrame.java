...
public class ProfesorFrame extends JFrame{
	...
	private ImageIcon b1Icon, b2Icon, b3Icon, b4Icon;
	...
	public ProfesorFrame(Utilizator profesor, ListaElev listaElev, ListaProfesor listaProfesor) throws IOException, ParseException{
		super(profesor.getNume());
		
		this.utilizator = profesor;
		...
		if(s.areSesiuniAnulate(utilizator.getNumeUtilizator())) {
			...
			JOptionPane.showConfirmDialog(null, panel, "Scheduled Sessions", JOptionPane.OK_OPTION);
		...
		profesor.setProfilePicture(profesor.getNumeUtilizator(), profilPozaLabel);
		gbc.gridx = 0;
		gbc.gridy = 0;
		gbc.gridwidth = 2;
		...
		b3 = new JButton();
		b3Icon = new ImageIcon("data/certificari.png");
		Image i3 = b3Icon.getImage();
		Image ni3 = i3.getScaledInstance(95, 28, Image.SCALE_SMOOTH);
		...
		b4 = new JButton();
		b4Icon = new ImageIcon("data/recenzie.png");
		Image i4 = b4Icon.getImage();
		Image ni4 = i4.getScaledInstance(95, 23, Image.SCALE_SMOOTH);
		b4Icon = new ImageIcon(ni4);
		b4.setPreferredSize(new Dimension(100,30));
		b4.setMaximumSize(new Dimension(100,30));
		b4.setUI(new BasicButtonUI());
		b4.setBackground(new Color(173, 216, 230));
	...
	private class ControllerButoane implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource()==b1){
				f = new DatePersonaleFrame(utilizator,listaElev,listaProfesor);
				f.setSize(300,480);
				f.setVisible(true);
			...
			if(e.getSource()==b2) {
				try {
					p = new ProgramareSesiuneMeditatiiFrame(listaElev,utilizator);
					p.setSize(700,90);
					p.setVisible(true);
			...
			if(e.getSource()==b3) {
				try {
					c = new AdaugaCertificatDialog((Profesor) utilizator);
					c.setSize(400,300);
					c.setVisible(true);
			...
			if(e.getSource()==b4) {
				r = new ProfesorVizualizareRecenzieFrame(utilizator.getNumeUtilizator());
				r.setSize(300,150);
				r.setVisible(true);
